...
export default function StylesPage() {
  ...
  const filteredStyles = styleCategories.filter(style =>
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
          {filteredStyles.length > 0 ? (
            ...
            <div className="col-span-full text-center py-10">
              <p className="text-gray-600 dark:text-gray-400 text-lg">No styles found. Try a different search term.</p>
              <button 
        ...
        {filteredStyles.length > 0 && (
          <div className="mt-6 md:mt-8 text-center text-sm md:text-base text-gray-600 dark:text-gray-400">
            Showing {filteredStyles.length} of {styleCategories.length} styles
          </div>
        )}
      </div>
    </motion.div>
