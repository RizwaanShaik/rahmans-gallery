...
export default function PlacesPage() {
  ...
  const filteredPlaces = placeCategories.filter(place =>
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="mb-6 md:mb-10">
          ...
          >
            ...
            <p className="text-center text-gray-600 dark:text-gray-400 mb-4 md:mb-8 text-base md:text-xl">
              Explore photography from around the world
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
          {filteredPlaces.length > 0 ? (
            ...
            <div className="col-span-full text-center py-10">
              <p className="text-gray-600 dark:text-gray-400 text-lg">No places found. Try a different search term.</p>
              <button 
        ...
        {filteredPlaces.length > 0 && (
          <div className="mt-6 md:mt-8 text-center text-sm md:text-base text-gray-600 dark:text-gray-400">
            Showing {filteredPlaces.length} of {placeCategories.length} places
          </div>
        )}
      </div>
    </motion.div>
