...
const photographyStylesCategories = [
  {
    id: 'macro',
    title: 'Macro',
...
export default function PhotographyStylesPage() {
  ...
  const filteredCategories = photographyStylesCategories.filter(category =>
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        {filteredCategories.length > 0 && (
          <div className="mt-6 md:mt-8 text-center text-sm md:text-base text-gray-600 dark:text-gray-400">
            Showing {filteredCategories.length} of {photographyStylesCategories.length} collections
          </div>
        )}
      </div>
    </motion.div>
