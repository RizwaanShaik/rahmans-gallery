...
const themeCategories = [
  ...
  },
  {
    id: 'tombs',
    title: 'Tombs',
    image: `${s3BaseUrl}/tumbs/hero/hero.jpeg`, // Using tumbs folder since tombs is empty
...
export default function ThemesPage() {
  ...
  const filteredThemes = themeCategories.filter(theme =>
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
          {filteredThemes.length > 0 ? (
            ...
            <div className="col-span-full text-center py-10">
              <p className="text-gray-600 dark:text-gray-400 text-lg">No themes found. Try a different search term.</p>
              <button 
        ...
        {filteredThemes.length > 0 && (
          <div className="mt-6 md:mt-8 text-center text-sm md:text-base text-gray-600 dark:text-gray-400">
            Showing {filteredThemes.length} of {themeCategories.length} themes
          </div>
        )}
      </div>
    </motion.div>
