...
const categoryHeroImages: { [key: string]: string } = {
  ...
  'hyderabad': `${s3BaseUrl}/Hyderabad/hero/Hyderabad_010_hero.jpeg`,
  'heritage': `${s3BaseUrl}/Heritage/hero/Heritage_006_hero.jpeg`,
  'tombs': `${s3BaseUrl}/Tombs/hero/hero.jpeg`,
  'rock-forms': `${s3BaseUrl}/RockFormations/hero/RockFormations_001_hero.jpeg`,
