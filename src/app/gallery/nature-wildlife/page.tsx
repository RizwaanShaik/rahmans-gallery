...
const natureWildlifeCategories = [
  {
    id: 'wildlife',
    title: 'Wildlife',
...
export default function NatureWildlifePage() {
  ...
  const filteredCategories = natureWildlifeCategories.filter(category =>
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="mb-6 md:mb-10">
          ...
          >
            ...
            <p className="text-center text-gray-600 dark:text-gray-400 mb-4 md:mb-8 text-base md:text-xl">
              Explore wildlife, natural landscapes, and geological formations
            </p>
          </motion.div>
        </div>
        ...
        <div className="mb-8 md:mb-12">
          <div className="relative max-w-2xl mx-auto">
            <input
              type="text"
              placeholder="Search nature & wildlife..."
        ...
        {filteredCategories.length > 0 && (
          <div className="mt-6 md:mt-8 text-center text-sm md:text-base text-gray-600 dark:text-gray-400">
            Showing {filteredCategories.length} of {natureWildlifeCategories.length} collections
          </div>
        )}
      </div>
    </motion.div>
